 ...
 * 
 * <p>The following are essentially the same:</p>
 * <listing version="3.0">
new DataLoader("file.zip", {format:"binary"}); 
new BinaryDataLoader("file.zip");
</listing>
 * 
 * <p>If you'd like to associate additional file extensions with BinaryDataLoader, you may use the
 * <code>LoaderMax.registerFileType()</code> method.</p>
 * 
 * <p><strong>OPTIONAL VARS PROPERTIES</strong></p>
 * <p>The following special properties can be passed into the BinaryDataLoader constructor via its <code>vars</code> 
 ...
 */	
	public class BinaryDataLoader extends DataLoader {
		 ...
		 * @param vars An object containing optional configuration details. For example: <code>new BinaryDataLoader("file.zip", {name:"myZipFile", onComplete:completeHandler, onProgress:progressHandler})</code>.
		 * 
