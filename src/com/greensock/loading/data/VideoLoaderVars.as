...
/**
 * Can be used instead of a generic Object to define the <code>vars</code> parameter of a VideoLoader's constructor. 
 * 
 ...
 * <p>Note that each method returns the VideoLoaderVars instance, so you can reduce the lines of code by method chaining (see example below).</p>
 *	
 * <p><strong>Without VideoLoaderVars:</strong></p><p><code>
 * new VideoLoader("video.flv", {name:"video", estimatedBytes:111500, container:this, width:200, height:100, onComplete:completeHandler, onProgress:progressHandler})</code></p>
 * 
 * <p><strong>With VideoLoaderVars</strong></p><p><code>
 * new VideoLoader("video.flv", new VideoLoaderVars().name("video").estimatedBytes(111500).container(this).width(200).height(100).onComplete(completeHandler).onProgress(progressHandler))</code></p>
 * 
