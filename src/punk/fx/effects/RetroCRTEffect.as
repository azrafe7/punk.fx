package punk.fx.effects
{
	 ...
	 * @author azrafe7
	 */
	public class RetroCRTEffect extends Effect
	{
		...
		/**
		 * Creates a new RetroCRTEffect with the specified values.
...
-		 * @param	scanLines		whether to draw the scan lines.
		 ...
		 */
		public function RetroCRTEffect(offsets:Array = null, scanLines:Boolean = true, noiseAmount:uint = 25) 
		{
			super();
		...
		override public function applyTo(bitmapData:BitmapData, clipRect:Rectangle = null):void
		{
			...
			if (noiseAmount > 0) {
				_noiseBMD.noise(Math.random() * 255, 0, noiseAmount, 7, true);
