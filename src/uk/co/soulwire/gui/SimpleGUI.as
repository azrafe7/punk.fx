...
package uk.co.soulwire.gui
{
	...
	public class SimpleGUI extends EventDispatcher
	{
		...
		private static const TOOLBAR_X : int = 0;
		private static const TOOLBAR_Y : int = 20;
		private static const COMPONENT_MARGIN : int = 4;
		...
		public function SimpleGUI(base:*, target : DisplayObjectContainer, title : String = null, hotKey : * = null)
		{
			_base = base;
			_target = target;

			_toggle.x = TOOLBAR_X + MARGIN;
			_toggle.y = TOOLBAR_Y + MARGIN;
			
			_toolbar.x = TOOLBAR_X + MARGIN;
			_toolbar.y = TOOLBAR_Y + MARGIN;
			
			_container.x = 0;
			_container.y = TOOLBAR_Y + TOOLBAR_HEIGHT + (MARGIN * 2);
